...
const GenreList = ({ kukubird, onSelectGenre }: Props) => {
  //{onSelectGenre}:Props} this function will be called when genre is selected
          ...
          <ListItem key={genre.id} paddingY="5px">
            <HStack>
              ...
              <Button
                textAlign="left"
                whiteSpace="normal"
                fontWeight={genre.id === kukubird?.id ? "bold" : "normal"}
